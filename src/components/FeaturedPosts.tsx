...
const FeaturedPosts = ({ posts }: { posts: Post[] }) => {
  ...
  // @ts-ignore
  const t = translations[language].featuredPosts;

  return (
    <section id="blog-destacados" className="py-20 sm:py-32 bg-gray-900/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-base font-semibold text-cyan-400 tracking-wider uppercase">{t.subtitle}</h2>
