        ...
        <main className="max-w-5xl mx-auto px-6 md:px-8 py-12 md:py-20">
            ...
            <section className="mb-24 section-fade-in">
                <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 border border-gray-200">
                    ...
                    <p className="text-center text-gray-600 mb-8">El crecimiento sostenible requiere una visión 360° del negocio...</p>
                </div>
            </section>
            ...
            <section className="mb-24 section-fade-in">
                ...
                <div className="mt-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">...</div>
                </div>
                <div className="mt-16">
                    <h3 className="text-2xl font-semibold text-center text-gray-700">PASO 2: PROSYSTEM™, El Integrador de Soluciones</h3>
                    <div className="mt-8 bg-white rounded-2xl shadow-lg p-8 md:p-12 border border-gray-200">...</div>
                </div>
            </section>
